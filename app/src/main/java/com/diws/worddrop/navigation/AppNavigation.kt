...
import com.diws.worddrop.ui.components.BottomNavBar
import com.diws.worddrop.ui.home.HomeScreen
import com.diws.worddrop.ui.onboarding.OnboardingScreen
import com.diws.worddrop.ui.practice.PracticeScreen
import com.diws.worddrop.ui.progress.ProgressScreen
import com.diws.worddrop.ui.settings.SettingsScreen
import com.diws.worddrop.ui.vocabulary.VocabularyScreen
import com.diws.worddrop.ui.worddetail.WordDetailScreen
...
private const val HOME_ENTER_DURATION = 650
...
fun AppNavigation(
    ...
    Scaffold(
        ...
        NavHost(
            ...
            // Default transitions for all other routes (simple fade)
            enterTransition = {
                fadeIn(tween(TRANSITION_DURATION, easing = FastOutSlowInEasing))
            },
            exitTransition = {
                fadeOut(tween(TRANSITION_DURATION, easing = FastOutSlowInEasing))
            },
            popEnterTransition = {
                fadeIn(tween(TRANSITION_DURATION, easing = FastOutSlowInEasing))
            },
